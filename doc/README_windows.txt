...
Intro
-----
Supro (SP) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Supro utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run supro-qt.exe.

Supro Core is the original Supro client and it builds the backbone of the network.
However, it downloads and stores the entire history of Supro transactions;
