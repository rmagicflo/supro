...
This mechanism has been integrated into Bitcore-Node-Supro which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/suprodev/insight-api-supro#web-socket-api](https://github.com/suprodev/insight-api-supro#web-socket-api)
* API: [https://github.com/suprodev/insight-api-supro#swifttx-transactions](https://github.com/suprodev/insight-api-supro#swifttx-transactions)
...
By default, the Supro Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Supro Core daemon:
