...
In order to support loading of multiple wallets in supro-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is supro.cpp.
...
Changes to supro.cpp
----------------------
supro.cpp is the entry point into supro-qt, and as such, will require some minor modifications to provide hooks for
