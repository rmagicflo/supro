Supro Core version 1.1.2 is now available from:

  <https://github.com/suprodev/supro/releases>

Mandatory update to block 235500.
This is a new version release, including various bug fixes and improvements.

Please report bugs using the issue tracker at github:

  <https://github.com/suprodev/supro/issues>

How to Upgrade
==============

If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/Supro-Qt (on Mac) or suprod/supro-qt (on Linux).

Compatibility
==============

Supro Core is extensively tested on multiple operating systems using
...
- Changed Masternode collateral to 50000 from block 235500
