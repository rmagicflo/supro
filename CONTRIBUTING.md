Contributing to Supro Core
==================================

The Supro Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Supro Core project, and is not to be
confused with overall Supro Network Protocol consensus changes.

Whether a pull request is merged into Supro Core rests with the project merge
...
Patches that change Supro consensus rules are considerably more involved than
...
Where a patch set proposes to change the Supro consensus, it must have been
...
The project leader is the release manager for each Supro Core release.
