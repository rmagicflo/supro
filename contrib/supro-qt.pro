...
RESOURCES += src/qt/supro.qrc src/qt/supro_locale.qrc

TRANSLATIONS += src/qt/locale/supro_bg.ts \
                src/qt/locale/supro_de.ts \
                src/qt/locale/supro_en.ts \
                src/qt/locale/supro_es.ts \
                src/qt/locale/supro_fi.ts \
                src/qt/locale/supro_fr.ts \
                src/qt/locale/supro_it.ts \
                src/qt/locale/supro_ja.ts \
                src/qt/locale/supro_pl.ts \
                src/qt/locale/supro_pt.ts \
                src/qt/locale/supro_ru.ts \
                src/qt/locale/supro_sk.ts \
                src/qt/locale/supro_sv.ts \
                src/qt/locale/supro_vi.ts \
                src/qt/locale/supro_zh_CN.ts \
                src/qt/locale/supro_zh_TW.ts
