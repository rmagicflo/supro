...
#if defined(NDEBUG)
#error "Supro cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in usp) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < Params().LAST_POW_BLOCK())
        ...
        nSubsidy = .2 * COIN;
    else if (nHeight > 10000 && nHeight <= 14000)
        nSubsidy = 22 * COIN;
    else if (nHeight > 14000 && nHeight <= 14100)
        nSubsidy = 25 * COIN;
    else if (nHeight > 14100 && nHeight <= 14200)
        nSubsidy = 27 * COIN;
    else if (nHeight > 14200 && nHeight <= 14300)
        nSubsidy = 29 * COIN;
    else if (nHeight > 14300 && nHeight <= 14400)
        nSubsidy = 31 * COIN;
    else if (nHeight > 14400 && nHeight <= 14500)
        nSubsidy = 33 * COIN;
    else if (nHeight > 14500 && nHeight <= 14600)
        nSubsidy = 35 * COIN;
    else if (nHeight > 14600 && nHeight <= 14700)
        nSubsidy = 37 * COIN;
    else if (nHeight > 14700 && nHeight <= 14800)
        nSubsidy = 39 * COIN;
    else if (nHeight > 14800 && nHeight <= 14900)
        nSubsidy = 41 * COIN;
    else if (nHeight > 14900 && nHeight <= 15000)
        nSubsidy = 44 * COIN;
        ...
        nSubsidy = 360 * COIN;
    else if (nHeight > 55000 && nHeight <= 60000)
        nSubsidy = 580 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SP: We use certain sporks during IBD, so check to see if they are
