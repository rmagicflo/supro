...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Supro features */
        {"supro", "masternode", &masternode, true, true, false},
        {"supro", "listmasternodes", &listmasternodes, true, true, false},
        {"supro", "getmasternodecount", &getmasternodecount, true, true, false},
        {"supro", "masternodeconnect", &masternodeconnect, true, true, false},
        {"supro", "masternodecurrent", &masternodecurrent, true, true, false},
        {"supro", "masternodedebug", &masternodedebug, true, true, false},
        {"supro", "startmasternode", &startmasternode, true, true, false},
        {"supro", "createmasternodekey", &createmasternodekey, true, true, false},
        {"supro", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"supro", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"supro", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"supro", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"supro", "getmasternodescores", &getmasternodescores, true, true, false},
        {"supro", "mnbudget", &mnbudget, true, true, false},
        {"supro", "preparebudget", &preparebudget, true, true, false},
        {"supro", "submitbudget", &submitbudget, true, true, false},
        {"supro", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"supro", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"supro", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"supro", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"supro", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"supro", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"supro", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"supro", "checkbudgets", &checkbudgets, true, true, false},
        {"supro", "mnsync", &mnsync, true, true, false},
        {"supro", "spork", &spork, true, true, false},
        {"supro", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"supro", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"supro", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"supro", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"supro", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"supro", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> supro-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47114/\n";
}
