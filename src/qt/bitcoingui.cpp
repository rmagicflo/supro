                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Supro Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and supro: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Supro Core"), this);
    aboutAction->setStatusTip(tr("Show information about Supro Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Supro"));
    ...
    openAction->setStatusTip(tr("Open a supro: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Supro Core help message to get a list with possible Supro command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Supro Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Supro network", "", count));
}
...
{
    QString strTitle = tr("Supro Core"); // default title
